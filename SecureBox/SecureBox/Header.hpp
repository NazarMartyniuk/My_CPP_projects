...
public:
	...
	bool flip(uint32_t x, uint32_t y) //На мою думку метод flip можна було написати по-іншому
	{
...
private:
	std::mt19937_64 rnd;
	std::vector<std::vector<bool>> m_LockSwitchers;//Вектор векторів це найкращий вибір

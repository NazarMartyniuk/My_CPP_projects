...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label8->Text = L"Пільговий відсоток:";
			// 
			// textBox7
			// 
			...
			this->label4->Text = L"Сума оплати з пільгою:";
			// 
			// button1
			// 
			...
			this->label9->Text = L"Місячний платіж:";
			// 
			// textBox9
			// 
			...
			this->label10->Text = L"Сума пільги:";
			// 
			// textBox10
			// 
